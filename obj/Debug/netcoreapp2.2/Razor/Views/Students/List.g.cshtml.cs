#pragma checksum "/Users/muratvuranok/Desktop/UIPath/Views/Students/List.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f3b5e3751365ad9ef6196580e8f56572a338bb52"
// <auto-generated/>
...
namespace UIPath.Models.Students
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f3b5e3751365ad9ef6196580e8f56572a338bb52", @"/Views/Students/List.cshtml")]
    ...
    <div class=""col d-flex justify-content-start"">
        <a href=""/Students/Index"" class=""btn btn-outline-info   mr-2""><i class=""fa fa-list""></i> Dersi Devam Eden Öğrenciler</a>
...
<div class=""modal fade"" id=""exampleModalCenter"" tabindex=""-1"" role=""dialog"" aria-labelledby=""exampleModalCenterTitle"" aria-hidden=""true"">
    <div class=""modal-dialog modal-dialog-centered"" rol");
   ...
   ");
        ...
        $("".dt-button"").removeClass().addClass(""btn btn-outline-secondary"");
            ...
            $('.zumre').on(""click"", function (e) {
                var items = document.getElementsByClassN");
                WriteLiteral(@"ame(""zumre"");
                itemList = [];
            ...
            $.fn.dataTableExt.afnFiltering.push(function (oSettings, aData, iDataIndex) {
                ...
                if (checked && itemList.includes(aData[6])) {
                    return true;
                }
    ...
    $(document).on(""click"", "".delete"", function () { 
        ...
        $.ajax({
            ...
            success: function (result) {
                var ");
                WriteLiteral(@"table = $(""#example"").DataTable();
                table.ajax.reload();
            }
        })
    })
...
<script src=""https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js""  integrity=""sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM""   crossorigin=""anonymous""></script>
 ");
            ...
            BeginContext(8942, 1, true);
            WriteLiteral("\n");
            EndContext();
            DefineSection("css", async() => {
                BeginContext(8956, 309, true);
                WriteLiteral(@"
